...
const Register = (props) => {
  ...
  const register = (e) => {
    ...
    if (password !== cPassword) {
      setCPasswordClass("form-control is-invalid shadow-none");
  ...
  useEffect(() => {
    if (isCPasswordDirty) {
      if (password === cPassword) {
        setCPasswordClass("form-control is-valid shadow-none");
      } else {
        setCPasswordClass("form-control is-invalid shadow-none");
      }
    }
  ...
  }, [user, loading, password, cPassword, navigate, isCPasswordDirty]);
