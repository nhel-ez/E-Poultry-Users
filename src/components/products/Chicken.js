...
const Chicken = (props) => {
  ...
  let [productName, setProductName] = useState("Living Chicken");
  let [quantity, setQuantity] = useState(1);
  let [price, setPrice] = useState(100);
  let [shippingFee, setShippingFee] = useState(60);
  let [totalPrice, setTotalPrice] = useState(160);
  let [status, setStatus] = useState("Add To Cart");
  let [url, setUrl] = useState("chicken");
        ...
        <div className="container py-5 h-100">
          <div className="row d-flex align-items-center justify-content-center h-100">
            <div className="col-md-8 col-lg-7 col-xl-6">
              <center>
                <img src={chicken} height={300} width={300} alt="poster" />
              </center>
            </div>
            <div className="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
              <center>
                <div className="card-body" style={{ marginTop: "20px" }}>
                  <h1 className="card-title mb-2">Living Chickens</h1>
